  ...
  return (
    <>
      {order.status !== "Delivered" && order.status !== "Cancelled" && (
        <div
          className="border-app-border overflow-hidden rounded-2xl border"
          style={{ height: 280 }}
        >
          {liveLocation && liveLocation.lat !== 0 ? (
            ...
            <div className="bg-app-green/5 flex-center h-full">
              <div className="text-center">
                <MapPinIcon className="text-app-green/40 mx-auto mb-2 size-8" />
                <p className="text-app-green/50 text-sm font-medium">
